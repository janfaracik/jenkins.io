...
Contributors that are interested in helping with the accessibility improvements should include their comments on link:https://issue-redirect.jenkins.io/issue/71153[JENKINS-71153].
...
Contributors that would like to help with the JavaScript work are invited to assign themselves one of the issues listed in link:https://issue-redirect.jenkins.io/issue/70906[JENKINS-70906].
